...
class sub_op :public node
{
    private:
        //Inherited branches, we'll make 0 and 1 indices the operands
        
    public:
        sub_op(node_ptr id_or_literal, node_ptr id_or_literal2)
        {

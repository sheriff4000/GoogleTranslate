...
class function_def : public node
{
    ...
    public:
        ...
        function_def(node_ptr _id, std::vector<node_ptr> _args, std::vector<node_ptr> statements);
        function_def(node_ptr _id, std::vector<node_ptr> statements); //no args in this one
